...
public class scrapePriceInfo5_all {

	static WebDriver driver = new FirefoxDriver();
	private static Logger logger = Logger.getLogger(scrapeSponsorLA.class.getName());
    ...
    public static void main(String args[]) throws IOException, InterruptedException, ClassNotFoundException, ParseException {
    	...
    	File folder = new File("final_scrape/USA_"+ts+"_ALL/");
		if (!folder.exists()) folder.mkdir();
		
		FileHandler fh = new FileHandler("final_scrape/USA_"+ts+"_ALL/log.txt");
    	...
    	for (String language : languages) {
	    	...
	    	for (String region : regions) {
	    		...
	    		folder = new File("final_scrape/USA_"+ts+"_ALL/"+region+"/");
	    		if (!folder.exists()) folder.mkdir();
	    		...
	    		for (String service : services) {
	    			count++;
	    			logger.info(service);
	    			folder = new File("final_scrape/USA_"+ts+"_ALL/"+region+"/"+service.replace("/", "")+"/");
		    		if (!folder.exists()) folder.mkdir();
    ...
    public static void getCityToPrice(String service, String region, 
    	...
    	for (Element link : links) {
    		...
    		//System.out.println(check);
    		if (check.contains("/online/classifieds/PostAdPPI.html/") && check.contains("?serverName="+region+".backpage.com&superRegion=") && !check.toLowerCase().contains("superRegion="+region) && !check.contains("?region=")) {
   ...
   public static void scrape(String region, String service, String nextUrl, String data_continue, 
	...
	if (!html.equals("")) {
   	File file = new File("final_scrape/USA_"+ts+"_ALL/"
